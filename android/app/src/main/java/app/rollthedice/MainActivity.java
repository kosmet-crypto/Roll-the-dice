...
/**
 * Hosts the Roll the Dice web app (bundled in assets/www) in a full-screen WebView.
...
public class MainActivity extends Activity {
    ...
    private static final String APK_NAME = "roll-the-dice.apk";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // A shake roll plays the dice sound without a tap first.
        s.setMediaPlaybackRequiresUserGesture(false);

        webView.addJavascriptInterface(new Bridge(), "DiceAndroid");
    ...
    /** Methods index.html can call as window.DiceAndroid.*. */
